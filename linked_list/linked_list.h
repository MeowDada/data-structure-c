...
extern linked_list_t linked_list_get_head_node(linked_list_t);
extern linked_list_t linked_list_get_tail_node(linked_list_t);
...
extern linked_list_t linked_list_insert_head(linked_list_t, linked_list_t);
extern linked_list_t linked_list_delete_head(linked_list_t);
