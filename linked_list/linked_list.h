...
extern void          linked_list_iterate(linked_list_t, PFany);
extern linked_list_t linked_list_get_node(linked_list_t, int);
extern void          linked_list_dump_list(linked_list_t, void (*)(any_t));
extern void          linked_list_insert(linked_list_t, linked_list_t);
extern void          linked_list_insert_tail(linked_list_t, linked_list_t);
extern void          linked_list_insert_front(linked_list_t, linked_list_t);
